...
linktitle: "Building Spendy Part 2"
type:
  - post
...
![spendy v2 landing](/image/spendy/v2/landing.png "Spendy v2 landing")
...
![spendy v2 locale switcher](/image/spendy/v2/locale_switcher.png "Spendy v2 locale switcher")
...
![spendy v2 dashboard](/image/spendy/v2/dashboard.png "Spendy v2 dashboard")
...
![spendy v2 month switcher](/image/spendy/v2/month_switcher_modal.png "Spendy v2 month switcher")

### Expenses

Clicking on a budget from the dashboard shows all expenses under that budget for the selected month:

![spendy v2 budget view](/image/spendy/v2/budget_view.png "Spendy v2 budget view")
...
![spendy v2 add expense](/image/spendy/v2/add_expense_modal.png "Spendy v2 add expense")
...
![spendy v2 all expenses](/image/spendy/v2/all_expenses.png "Spendy v2 all expenses")
...
![spendy v2 user dropdown](/image/spendy/v2/user_dropdown.png "Spendy v2 user dropdown")

My Budgets:

![spendy v2 all budgets](/image/spendy/v2/all_budgets.png "Spendy v2 all budgets")
